 ...
 *
 * @see <a href="https://nexus-framework.com/docs/world-assembly/types/cell-voxel-data/">FNCellVoxelData</a>
 */
...
private:
	...
	/** Flat per-voxel storage for ENCellVoxel flag bitmasks, indexed via the generated N_FLAT_3D_ARRAY_BASE accessors. */
	UPROPERTY(VisibleAnywhere)
	TArray<uint8> Data;
