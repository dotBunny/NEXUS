 ...
 * @see <a href="https://nexus-framework.com/docs/world-assembly/types/tissue/">UNTissue</a>
 */
UCLASS(ClassGroup = "NEXUS", DisplayName = "NEXUS | Tissue",
	meta = (DocsURL="https://nexus-framework.com/docs/world-assembly/types/tissue"))
