...
/**
 * PCG settings node that emits every junction registered with FNWorldAssemblyRegistry as a point attribute set.
 */
...
public:
	...
	virtual FText GetNodeTooltipText() const override { return INVTEXT("Gets all registered Junction data from FNWorldAssemblyRegistry."); }
