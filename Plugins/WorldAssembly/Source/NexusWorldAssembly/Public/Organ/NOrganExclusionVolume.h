 ...
 * @see <a href="https://nexus-framework.com/docs/world-assembly/types/organ-exclusion-volume/">ANOrganExclusionVolume</a>
 */
...
class NEXUSWORLDASSEMBLY_API ANOrganExclusionVolume : public AVolume
{
	GENERATED_BODY()
};