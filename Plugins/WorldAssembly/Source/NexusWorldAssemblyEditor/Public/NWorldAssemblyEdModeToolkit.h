...
public:
	...
	/** Record the running tool's name for the rail's active-tool row. */
	virtual void OnToolStarted(UInteractiveToolManager* Manager, UInteractiveTool* Tool) override;

	/** Clear the running tool's name, collapsing the rail's active-tool row. */
...
private:
	...
	/** Display name of the running tool, or empty when none is. Drives the rail's active-tool row. */
