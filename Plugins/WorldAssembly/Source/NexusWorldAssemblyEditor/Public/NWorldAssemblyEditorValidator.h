...
#include "NWorldAssemblyEditorValidator.generated.h"

/**
 * Editor data validator that dispatches into World Assembly-specific sub-validators based on asset type.
 *
 ...
 */
UCLASS()
class UNWorldAssemblyEditorValidator : public UEditorValidatorBase
{
	GENERATED_BODY()
...
private:
	/** World-asset sub-validator — checks World Assembly cell/junction consistency for level assets. */
