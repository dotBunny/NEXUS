 ...
 *         panel that lays out fixed-size children — SWrapBox with UseAllottedSize, which is what
 *         FNWorldAssemblyEdModeRail::CreateTitledCommandPalette puts them in.
 * @see <a href="https://nexus-framework.com/docs/plugins/world-assembly/editor-mode/">World Assembly Editor Mode</a>
 */
class NEXUSWORLDASSEMBLYEDITOR_API SNCommandTile final : public SCompoundWidget
{
public:
