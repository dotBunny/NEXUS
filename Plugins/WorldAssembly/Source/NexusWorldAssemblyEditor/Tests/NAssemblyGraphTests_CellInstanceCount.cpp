	...
	N_TEST_CONTEXT_ANYWHERE)
{
	...
	FNAssemblyGraphCellNode* NodeA = FNAssemblyGraphNodeFactory::CreateCellNode(&Cell, FVector::ZeroVector, FRotator::ZeroRotator);
	...
	FNAssemblyGraphCellNode* NodeB = FNAssemblyGraphNodeFactory::CreateCellNode(&Cell, FVector::ZeroVector, FRotator::ZeroRotator);
