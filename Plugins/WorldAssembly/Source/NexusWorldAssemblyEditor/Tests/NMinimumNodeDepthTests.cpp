	...
	N_TEST_CONTEXT_ANYWHERE)
{
	...
	FNAssemblyGraphCellNode* Start = FNAssemblyGraphNodeFactory::CreateCellNode(&Cell, FVector::ZeroVector, FRotator::ZeroRotator);
	Graph.RegisterNode(Start);
	Bone->Connect(Start);

	FNAssemblyGraphCellNode* NeighborA = FNAssemblyGraphNodeFactory::CreateCellNode(&Cell, FVector::ZeroVector, FRotator::ZeroRotator);
	Graph.RegisterNode(NeighborA);
	Start->Connect(NeighborA);

	FNAssemblyGraphCellNode* NeighborB = FNAssemblyGraphNodeFactory::CreateCellNode(&Cell, FVector::ZeroVector, FRotator::ZeroRotator);
