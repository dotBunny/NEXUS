...
void FNWorldAssemblyEditorCellUtils::AddActor()
{
...
void FNWorldAssemblyEditorCellUtils::RemoveActor()
{
...
void FNWorldAssemblyEditorCellUtils::ResetCell()
{
...
void FNWorldAssemblyEditorCellUtils::CalculateAll()
{
	CalculateBounds();
	CalculateHull();
	CalculateVoxelData();
...
void FNWorldAssemblyEditorCellUtils::CalculateBounds()
{
	ANCellActor* CellActor = FNWorldAssemblyEditorUtils::GetCellActorFromCurrentWorld();
	if (!ensure(CellActor != nullptr)) return;
...
void FNWorldAssemblyEditorCellUtils::CalculateHull()
{
	ANCellActor* CellActor = FNWorldAssemblyEditorUtils::GetCellActorFromCurrentWorld();
	if (!ensure(CellActor != nullptr)) return;
...
void FNWorldAssemblyEditorCellUtils::CalculateVoxelData()
{
	ANCellActor* CellActor = FNWorldAssemblyEditorUtils::GetCellActorFromCurrentWorld();
	if (!ensure(CellActor != nullptr)) return;
...
void FNWorldAssemblyEditorCellUtils::ModifyCellRootDetails(const FText& TransactionName, TFunctionRef<void(FNCellRootDetails&)> Mutator)
{
...
bool FNWorldAssemblyEditorCellUtils::QueryCellRootDetails(TFunctionRef<bool(const FNCellRootDetails&)> Reader)
{
	const UWorld* CurrentWorld = FNEditorUtils::GetCurrentWorld();
...
void FNWorldAssemblyEditorCellUtils::CaptureThumbnail()
{
...
void FNWorldAssemblyEditorCellUtils::ToggleBoundsCalculateOnSave()
{
	ModifyCellRootDetails(
		NSLOCTEXT("NexusWorldAssemblyEditor", "FNWorldAssemblyEditorCellOperations_ToggleBoundsCalculateOnSave", "Toggle Calculate Bounds On Save"),
...
bool FNWorldAssemblyEditorCellUtils::ToggleBoundsCalculateOnSave_IsActionChecked()
{
	return QueryCellRootDetails(
		[](const FNCellRootDetails& Details) { return Details.BoundsSettings.bCalculateOnSave; });
}

void FNWorldAssemblyEditorCellUtils::ToggleHullCalculateOnSave()
{
	ModifyCellRootDetails(
		NSLOCTEXT("NexusWorldAssemblyEditor", "FNWorldAssemblyEditorCellOperations_ToggleHullCalculateOnSave", "Toggle Calculate Hull On Save"),
		[](FNCellRootDetails& Details)
		{
...
bool FNWorldAssemblyEditorCellUtils::ToggleHullCalculateOnSave_IsActionChecked()
{
	return QueryCellRootDetails(
		[](const FNCellRootDetails& Details) { return Details.HullSettings.bCalculateOnSave; });
}

void FNWorldAssemblyEditorCellUtils::ToggleHullAllowNonConvex()
{
	ModifyCellRootDetails(
		NSLOCTEXT("NexusWorldAssemblyEditor", "FNWorldAssemblyEditorCellOperations_ToggleHullAllowNonConvex", "Toggle Allow Non-Convex Hull"),
		[](FNCellRootDetails& Details)
		{
...
bool FNWorldAssemblyEditorCellUtils::ToggleHullAllowNonConvex_IsActionChecked()
{
	return QueryCellRootDetails(
		[](const FNCellRootDetails& Details) { return Details.HullSettings.bAllowNonConvex; });
}

void FNWorldAssemblyEditorCellUtils::ToggleVoxelCalculateOnSave()
{
	ModifyCellRootDetails(
		NSLOCTEXT("NexusWorldAssemblyEditor", "FNWorldAssemblyEditorCellOperations_ToggleVoxelCalculateOnSave", "Toggle Calculate Voxel On Save"),
		[](FNCellRootDetails& Details)
		{
...
bool FNWorldAssemblyEditorCellUtils::ToggleVoxelCalculateOnSave_IsActionChecked()
{
	return QueryCellRootDetails(
		[](const FNCellRootDetails& Details) { return Details.VoxelSettings.bCalculateOnSave; });
}

void FNWorldAssemblyEditorCellUtils::ToggleVoxelData()
{
	ModifyCellRootDetails(
		NSLOCTEXT("NexusWorldAssemblyEditor", "FNWorldAssemblyEditorCellOperations_ToggleVoxelData", "Use Voxel Data"),
		[](FNCellRootDetails& Details)
		{
...
bool FNWorldAssemblyEditorCellUtils::ToggleVoxelData_IsActionChecked()
{
	return QueryCellRootDetails(
