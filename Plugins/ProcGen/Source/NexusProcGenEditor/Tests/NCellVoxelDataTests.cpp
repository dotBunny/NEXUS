...
N_TEST_CRITICAL(FNProcGenTests_CellVoxelData_Uniform, "NEXUS::UnitTests::NProcGen::NCellVoxelData_Uniform", N_TEST_CONTEXT_ANYWHERE)
{
	...
	// TEST
	{
		...
		CHECK_EQUALS(TEXT("Expected 9,9,9 to be occupied when read from flat array."), VoxelData.GetData(999),  FNCellVoxelData::ConvertElement(ENCellVoxel::CVD_Occupied))
		...
		CHECK_EQUALS(TEXT("Expected round tripped altered data to match."), AlteredData,  FNCellVoxelData::ConvertElement(ENCellVoxel::CVD_Occupied))
	}
}
