...
#define N_COLLISION_VISUALIZER_HIT_COLOR FColor::Green
#define N_COLLISION_VISUALIZER_MID_COLOR FColor::Blue
#define N_COLLISION_VISUALIZER_MISS_COLOR FColor::Red
