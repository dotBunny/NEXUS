...
struct FNCollisionVisualizerDrawing
{
	...
	UPROPERTY(EditAnywhere, Category = "Collision Test|Drawing", DisplayName="Draw Mode", meta=(Bitmask,BitmaskEnum="/Script/NexusUIEditor.ECollisionVisualizerDrawMode"))
