 ...
 * @see <a href="https://nexus-framework.com/docs/ui/types/components/slider/">UNSlider</a>
 */
...
public:
	...
	UFUNCTION(BlueprintCallable, Category="NEXUS|User Interface", DisplayName="Set Value (No Broadcast)",
		meta=(DocsURL="https://nexus-framework.com/docs/ui/types/components/slider/#set-value-no-broadcast"))
