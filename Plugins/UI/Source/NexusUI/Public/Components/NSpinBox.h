 ...
 * @see <a href="https://nexus-framework.com/docs/ui/types/components/spin-box/">UNSpinBox</a>
 */
...
public:
	...
	UFUNCTION(BlueprintCallable, Category="NEXUS|User Interface", DisplayName="Set Value (No Broadcast)",
		meta=(DocsURL="https://nexus-framework.com/docs/ui/types/components/spin-box/#set-value-no-broadcast"))
