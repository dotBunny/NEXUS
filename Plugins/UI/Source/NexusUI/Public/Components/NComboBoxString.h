 ...
 * @see <a href="https://nexus-framework.com/docs/ui/types/components/combobox-string/">UNComboBoxString</a>
 */
...
public:
	...
	UFUNCTION(BlueprintCallable, Category="NEXUS|User Interface", DisplayName="Set Selected Option (No Broadcast)",
		meta=(DocsURL="https://nexus-framework.com/docs/ui/types/components/combobox-string/#set-selected-option-no-broadcast"))
	...
	UFUNCTION(BlueprintCallable, Category="NEXUS|User Interface", DisplayName="Set Selected Index (No Broadcast)",
		meta=(DocsURL="https://nexus-framework.com/docs/ui/types/components/combobox-string/#set-selected-index-no-broadcast"))
