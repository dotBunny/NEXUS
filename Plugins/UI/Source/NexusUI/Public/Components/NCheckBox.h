 ...
 * @see <a href="https://nexus-framework.com/docs/ui/types/components/check-box/">UNCheckBox</a>
 */
...
public:
	...
	UFUNCTION(BlueprintCallable, Category="NEXUS|User Interface", DisplayName="Set IsChecked (No Broadcast)",
		meta=(DocsURL="https://nexus-framework.com/docs/ui/types/components/check-box/#set-ischecked-no-broadcast"))
	...
	UFUNCTION(BlueprintCallable, Category="NEXUS|User Interface", DisplayName="Set Checked State (No Broadcast)",
		meta=(DocsURL="https://nexus-framework.com/docs/ui/types/components/check-box/#set-checkedstate-no-broadcast"))
