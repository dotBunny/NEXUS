 ...
 * @see <a href="https://nexus-framework.com/docs/ui/types/components/list-view/">UNListView</a>
 */
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "NEXUS|UI",
		meta=(DocsURL="https://nexus-framework.com/docs/ui/types/components/list-view/#get-reference-object"))
