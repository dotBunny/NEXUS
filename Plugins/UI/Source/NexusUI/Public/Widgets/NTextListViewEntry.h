...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Text",
		meta=(DocsURL="https://nexus-framework.com/docs/ui/types/widgets/text-list-view-entry/#set-background-color"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Text",
		meta=(DocsURL="https://nexus-framework.com/docs/ui/types/widgets/text-list-view-entry/#set-text"))
 ...
 * @see <a href="https://nexus-framework.com/docs/ui/types/widgets/text-list-view-entry/">UNTextListViewEntry</a>
 */
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "NEXUS|UI",
		meta=(DocsURL="https://nexus-framework.com/docs/ui/types/widgets/text-list-view-entry/#set-text-color"))
