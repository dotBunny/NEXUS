 ...
 * @see <a href="https://nexus-framework.com/docs/core/editor-types/editor-library/">UNEditorLibrary</a>
 */
...
public:
	...
	UFUNCTION(BlueprintCallable, DisplayName = "Select Actor", Category = "NEXUS|Editor",
		meta=(DocsURL="https://nexus-framework.com/docs/core/editor-types/editor-library/#select-actor"))
