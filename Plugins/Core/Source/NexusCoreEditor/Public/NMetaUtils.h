 ...
 *
 * Pair with N_META_TYPE_HEADER in the class body; this macro lives in the .cpp file.
 ...
 */
#define N_META_TYPE(Name, MetaKey) \
 ...
 *
 * Use in the class header; pair with N_META_TYPE in the .cpp to supply the key's FName.
 * @param Name The logical name of the key — generates HasName / GetName / TryGetName / GetNameUnsafe.
 */
#define N_META_TYPE_HEADER(Name) \
	public: \
...
public:
	...
	N_META_TYPE_HEADER(ExternalDocumentation)
};
