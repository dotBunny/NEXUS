...
N_TEST_HIGH(FNVectorUtils_TransformPoint_NoRotation, "NEXUS::UnitTests::NCore::VectorUtils::TransformPoint_NoRotation", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_TransformPoint_ZeroOrigin, "NEXUS::UnitTests::NCore::VectorUtils::TransformPoint_ZeroOrigin", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_RotateAndOffsetPoint_NoRotation, "NEXUS::UnitTests::NCore::VectorUtils::RotateAndOffsetPoint_NoRotation", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_RotateAndOffsetPoint_ZeroOffset, "NEXUS::UnitTests::NCore::VectorUtils::RotateAndOffsetPoint_ZeroOffset", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_RotatedAroundPivot_ZeroRotation, "NEXUS::UnitTests::NCore::VectorUtils::RotatedAroundPivot_ZeroRotation", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_RotatedAroundPivot_Yaw180, "NEXUS::UnitTests::NCore::VectorUtils::RotatedAroundPivot_Yaw180", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_GetClosestGridIntersection_OnGrid, "NEXUS::UnitTests::NCore::VectorUtils::GetClosestGridIntersection_OnGrid", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_GetClosestGridIntersection_RoundsDown, "NEXUS::UnitTests::NCore::VectorUtils::GetClosestGridIntersection_RoundsDown", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_GetClosestGridIntersection_RoundsUp, "NEXUS::UnitTests::NCore::VectorUtils::GetClosestGridIntersection_RoundsUp", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_GetClosestGridIntersection_Zero, "NEXUS::UnitTests::NCore::VectorUtils::GetClosestGridIntersection_Zero", N_TEST_CONTEXT_ANYWHERE)
{
	const FVector GridSize(50.f, 50.f, 50.f);
...
N_TEST_HIGH(FNVectorUtils_GetCrunchedGridUnit_OnGrid, "NEXUS::UnitTests::NCore::VectorUtils::GetCrunchedGridUnit_OnGrid", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_GetCrunchedGridUnit_OffGrid, "NEXUS::UnitTests::NCore::VectorUtils::GetCrunchedGridUnit_OffGrid", N_TEST_CONTEXT_ANYWHERE)
{
...
N_TEST_HIGH(FNVectorUtils_GetCrunchedGridUnit_Zero, "NEXUS::UnitTests::NCore::VectorUtils::GetCrunchedGridUnit_Zero", N_TEST_CONTEXT_ANYWHERE)
{
