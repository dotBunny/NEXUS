 ...
 * @see <a href="https://nexus-framework.com/docs/core/types/developer/test-latent-commands/test-latent-command-world-test-with-base/">FNTestLatentCommand_WorldTestWithBase</a>
 */
