 ...
 * @see <a href="https://nexus-framework.com/docs/core/types/developer/test-latent-commands/test-latent-command-pre-performance-test/">FNTestLatentCommand_PrePerformanceTest</a>
 */
