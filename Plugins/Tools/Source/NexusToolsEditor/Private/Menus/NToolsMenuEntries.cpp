...
void FNToolsMenuEntries::AddMenuEntries()
{
	...
	LeakCheckMenuEntry.DisplayName = NSLOCTEXT("NexusToolsEditor","LeakCheck", "Leak Check");
	LeakCheckMenuEntry.Tooltip = NSLOCTEXT("NexusToolsEditor","LeakCheck_Tooltip", "Capture and process all UObjects over a period of 5 seconds to check for leaks."),
	LeakCheckMenuEntry.Icon = FSlateIcon(FNToolsEditorStyle::GetStyleSetName(), "Command.LeakCheck");
	...
	CleanLogsMenuEntry.DisplayName = NSLOCTEXT("NexusToolsEditor","CleanLogsFolder", "Clean Logs Folder");
	CleanLogsMenuEntry.Tooltip = NSLOCTEXT("NexusToolsEditor","CleanLogsFolder_Tooltip", "Removes old logs from the Saved\\Logs folder."),
	CleanLogsMenuEntry.Icon = FSlateIcon(FNToolsEditorStyle::GetStyleSetName(), "Command.CleanLogsFolder");
