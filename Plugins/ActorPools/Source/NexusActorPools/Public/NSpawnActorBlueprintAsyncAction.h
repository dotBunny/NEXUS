 ...
 * @see <a href="https://nexus-framework.com/docs/actor-pools/types/spawn-actor-async/">UNSpawnActorBlueprintAsyncAction</a>
 */
UCLASS()
...
public:
	...
	UFUNCTION(BlueprintCallable, DisplayName="Spawn Actor Async", Category = "NEXUS|Actor Pools",
		meta=(DocsURL="https://nexus-framework.com/docs/actor-pools/types/spawn-actor-async/", BlueprintInternalUseOnly = "true", WorldContext = "WorldContextObject"))
