 ...
 * @see <a href="https://nexus-framework.com/docs/actor-pools/types/get-actor-async/">UNGetActorBlueprintAsyncAction</a>
 */
UCLASS()
...
public:
	...
	UFUNCTION(BlueprintCallable, DisplayName="Get Actor Async", Category = "NEXUS|Actor Pools",
		meta=(DocsURL="https://nexus-framework.com/docs/actor-pools/types/get-actor-async/", BlueprintInternalUseOnly = "true", WorldContext = "WorldContextObject"))
