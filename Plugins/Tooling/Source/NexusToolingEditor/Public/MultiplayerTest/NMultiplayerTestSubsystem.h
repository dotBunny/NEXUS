...
#include "NMultiplayerTestSubsystem.generated.h"

/**
 * Editor subsystem that drives the Multiplayer Test workflow.
 *
 ...
 * @see <a href="https://nexus-framework.com/docs/tooling/editor-types/multiplayer-test/multiplayer-test-subsystem/">UNMultiplayerTestSubsystem</a>
 */
UCLASS()
class NEXUSTOOLINGEDITOR_API UNMultiplayerTestSubsystem : public UEditorSubsystem, public FTickableGameObject
{
	GENERATED_BODY()
	N_EDITOR_TICKABLE_SUBSYSTEM(UNMultiplayerTestSubsystem)
	 ...
	 */
	UFUNCTION(meta=(DocsURL="https://nexus-framework.com/docs/tooling/editor-types/multiplayer-test/multiplayer-test-subsystem/#add-local-process"))
