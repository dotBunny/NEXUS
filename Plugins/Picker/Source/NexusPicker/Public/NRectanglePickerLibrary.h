 ...
 * @see <a href="https://nexus-framework.com/docs/picker/distributions/rectangle/">UNRectanglePickerLibrary</a>
 */
...
class NEXUSPICKER_API UNRectanglePickerLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintCallable, DisplayName = "Rectangle: Next Point", Category = "NEXUS|Picker|Rectangle",
		meta=(DocsURL="https://nexus-framework.com/docs/picker/distributions/rectangle/#next-point", WorldContext = "WorldContextObject"))
	...
	UFUNCTION(BlueprintCallable, DisplayName = "Rectangle: Random Point", Category = "NEXUS|Picker|Rectangle",
		meta=(DocsURL="https://nexus-framework.com/docs/picker/distributions/rectangle/#random-point", WorldContext = "WorldContextObject"))
	...
	UFUNCTION(BlueprintCallable, DisplayName = "Rectangle: Tracked Point", Category = "NEXUS|Picker|Rectangle",
		meta=(DocsURL="https://nexus-framework.com/docs/picker/distributions/rectangle/#tracked-point", WorldContext = "WorldContextObject"))
	...
	meta=(DocsURL="https://nexus-framework.com/docs/picker/distributions/rectangle/#one-shot-point", WorldContext = "WorldContextObject"))
